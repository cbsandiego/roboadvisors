    ...
    if age is not None:
        ...
        if int(age) < 0 or int(age) >= 65:
            return build_validation_result(
                False,
                "age",
                "Unfortunately, due to age restrictions, we cannot assist you with any retirement advice."
                )
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "Unfortunately, we cannot assist you with any advice for investments under $5000"
                )
